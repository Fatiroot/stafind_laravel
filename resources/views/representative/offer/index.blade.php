<x-dashboard>
    <div class="m-4" style="text-align: right ;">
        <button type="submit" class="text-white p-2 border-0 rounded-md bg-violet-800">
            <a href="{{ route('representativeOffer.create') }}" class="block">Create Offer</a>
        </button>
    </div>
                    ...
                    <div>
                        ...
                        <div id="dropdownDotsHorizontal-{{ $offer->id }}"
                            ...
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                ...
                                <li>
                                    <a href="{{ route('representativeOffer.edit', ['representativeOffer'=> $offer->id]) }}"
                            ...
                            <li>
                                <a href="{{ route('requestsRep',$offer->id) }}"
                            ...
                            <div class="py-2">
                                <form action="{{ route('representativeOffer.destroy',['representativeOffer'=> $offer->id]) }}" method="post" class="hover:bg-gray-100">
                                    @method('delete')
                                    @csrf
                                    <button
